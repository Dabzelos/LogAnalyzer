...
func TestDataHolder_Parser(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			logs: []string{
				"80.91.33.133 - - [17/May/2015:08:05:24 +0000] \"/downloads/product_1 HTTP/1.1\" 304 0 \"-\" \"Debian APT-HTTP/1.3 (0.8.16~exp12ubuntu10.17)\"",
				"93.180.71.3 - - [May/2015:08:05:23 +0000] \"GET /downloads/product_1 HTTP/1.1\" 304 0 \"-\" \"Debian APT-HTTP/1.3 (0.8.16~exp12ubuntu10.21)\"",
				"80.91.33.133 - - [17/May/2015:08:05:24 +0000] \"GET /downloads/product_1 HTTP/1.1\"  \"-\" \"Debian APT-HTTP/1.3 (0.8.16~exp12ubuntu10.17)\"",
			},
			parsedData: domain.DataHolder{
				TotalCounter:       0,
				UnparsedLogs:       3,
		...
		},
		{
			...
			logs: []string{
				"80.91.33.133 - - [17/May/2015:08:15:24 +0000] \"GET /downloads/product_1 HTTP/1.1\" 304 0 \"-\" \"Debian APT-HTTP/1.3 (0.8.16~exp12ubuntu10.17)\"",
				"93.180.71.3 - - [17/May/2015:08:09:23 +0000] \"GET /downloads/product_1 HTTP/1.1\" 304 0 \"-\" \"Debian APT-HTTP/1.3 (0.8.16~exp12ubuntu10.21)\"",
				"80.91.33.133 - - [17/May/2015:08:08:24 +0000] \"GET /downloads/product_1 HTTP/1.1\" 304 0 \"-\" \"Debian APT-HTTP/1.3 (0.8.16~exp12ubuntu10.17)\"",
				"217.168.17.5 - - [17/May/2015:08:07:34 +0000] \"GET /downloads/product_1 HTTP/1.1\" 200 490 \"-\" \"Debian APT-HTTP/1.3 (0.8.10.3)\"",
				"217.168.17.5 - - [17/May/2015:08:06:09 +0000] \"GET /downloads/product_2 HTTP/1.1\" 200 490 \"-\" \"Debian APT-HTTP/1.3 (0.8.10.3)\"",
	...
	for _, tc := range testCases {
		t.Run(fmt.Sprintf(tc.testScenario), func(t *testing.T) {
